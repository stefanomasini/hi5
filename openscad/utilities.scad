...
servo_holder_base_to_arm_distance = servo_axle_top_distance_from_holder_base+servo_holder_thickness;
servo_holder_width = servo_width + servo_holder_thickness*2;
